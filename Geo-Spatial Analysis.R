...
## ----This_Checks_your_Name_Space,echo=FALSE,warning=FALSE,message=FALSE-----
if(!requireNamespace(
  c(
    'rnaturalearth',
    'sf',
...
## ----This_Checks_your_Name_Space_If_This_Package_is_Installed,echo=FALSE,warning=FALSE,message=FALSE----
